 ...
 * @version 1.0
 */
public class ListApprovalAction extends Action {
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			ListApprovalActionForm frm = (ListApprovalActionForm) form;
			System.out.println("ListApprovalAction:" + frm.getButton());
			...
			request.setAttribute("ListApprovalForm", frm);
	 ...
	 * @throws Exception
	 */
	private EditReportActionForm doSeq(Connection dbConn, CommonSession commonSession, ListApprovalActionForm frm) throws Exception {
		...
		f.setViewMode(Param.MODE_APPROVAL);
