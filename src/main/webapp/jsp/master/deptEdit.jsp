...
<bean:define id="title"><bean:message key="title.dept.edit" /></bean:define><!-- 所属編集 -->
...
<body>
  <div class="container">
    ...
    <h3 class="page-header"><bean:message key="title.dept.edit" /></h3><!-- 所属編集 -->

    <html:form action="/DeptEdit" method="post" styleClass="form-horizontal">
      <div class="form-group">
        <label class="col-sm-3 control-label"><bean:message key="deptEdit.code" /></label><!-- 所属コード -->
        <div class="col-sm-6">
           <logic:equal property="viewMode" name="DeptEditForm" value="1">
           ...
           <logic:messagesPresent property="deptCode"><%haserr="has-error";%></logic:messagesPresent>
            <div class="input-group <%=haserr%>">
              <html:text property="deptCode" maxlength="3" styleClass="form-control" />
            <span class="input-group-addon"><bean:message key="label.required" /></span>
            </div>
            <p class="text-danger"><html:errors property="deptCode"/></p>
            </logic:equal>
            <logic:equal property="viewMode" name="DeptEditForm" value="2">
              <html:text property="deptCode" maxlength="3" styleClass="form-control" readonly="true" />
            </logic:equal>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
           <bean:define id="haserr" value=""/>
           <logic:messagesPresent property="deptName"><%haserr="has-error";%></logic:messagesPresent>
            <div class="input-group <%=haserr%>">
              <html:text property="deptName" maxlength="50" styleClass="form-control" />
            <span class="input-group-addon"><bean:message key="label.required" /></span>
            </div>
            <p class="text-danger"><html:errors property="deptName"/></p>
        </div>
        <div class="col-sm-3"></div>
      </div>
