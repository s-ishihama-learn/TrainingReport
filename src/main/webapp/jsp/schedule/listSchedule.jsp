...
<bean:define id="title"><bean:message key="title.schedule.list" /></bean:define><!-- スケジュール一覧 -->
...
<!--
	function doScheduleEdit(userId, viewDate, seq) {
...
<body>
  <div class="container">
    ...
    <h3 class="page-header"><bean:message key="title.schedule.list" /></h3><!-- スケジュール一覧 -->

    <html:form action="/ListSchedule" method="post">
      ...
      <table class="table table-hover">
        <thead>
          <tr>
            ...
            <th class="col-sm-2"><bean:message key="editSchedule.time" /></th><!-- 予定時刻 -->
            <th class="col-sm-6"><bean:message key="editSchedule.title" /></th><!-- タイトル -->
          </tr>
        </thead>
        <tbody>
          <logic:iterate id="item" property="scheduleList" name="ListScheduleForm">
            <tr>
              ...
              <% String itemStr = "javascript:doScheduleEdit('" + userId + "','" + viewDate + "','" + seq + "')"; %>
